...
Все чанки, естественно, быстро и эффективно эмбеддим заранее на своём компе, а в браузере останется лишь заэмбеддить запрос пользователя и найти наиболее похожие вектора из сохранённых заранее данных. Задеплоил всё эту магию, работает, но есть нюанс - при каждом обновлении страницы пользователю надо перекачивать 123 мегабайта, а это в лучшем случае несколько секунд. Чатимся с Claude, гуглим, выход есть - [IndexedDB](https://www.w3.org/TR/IndexedDB/).
...
Сами LLM я беру сейчас бесплантые, но перебираю несколько на случай отключений и ограничений. По умолчанию стоит Gemma 3 27B.
