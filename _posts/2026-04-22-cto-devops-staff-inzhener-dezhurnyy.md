...
excerpt: В посте разбирается вопрос о том, должен ли CTO небольшой компании самостоятельно
  реализовывать технические задачи или только делегировать их, и как появление инструментов
  вроде Claude Code меняет эту динамику. Обсуждаются плюсы такого подхода (снятие
  боттленеков, углубление понимания системы, психологическое удовлетворение) и минусы
  (привыкание команды к помощи, отнятие возможности роста для других, накопление задач
  на поддержку), а также предлагается чек-лист для принятия осознанного решения о
  том, браться ли за конкретную задачу.
layout: post
source_type: direct
telegram_url: https://t.me/varim_ml/180
tags:
- жека
- management
