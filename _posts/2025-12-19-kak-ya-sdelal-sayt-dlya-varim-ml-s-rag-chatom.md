...
excerpt: 'Пост рассказывает о создании персонального блога на базе Jekyll и Github Pages с уникальными техническими решениями: автоматизированный импорт постов из Telegram, RAG-чат полностью на клиентской стороне с использованием ML-моделей в браузере и Cloudflare Worker для безопасного взаимодействия с LLM. Особенностью проекта является минималистичный дизайн, возможность сортировки и фильтрации постов, а также интерактивный поиск с использованием эмбеддинг-модели и гибридного поиска.'
layout: post
source_type: direct
tags:
- жека
