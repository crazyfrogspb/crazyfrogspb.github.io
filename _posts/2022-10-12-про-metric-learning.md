...
excerpt: Пост посвящен metric learning в компьютерном зрении, где основная цель -
  создание генератора эмбеддингов, который располагает объекты одной категории близко,
  а объекты разных категорий - далеко. Рассматриваются основные подходы к metric learning,
  включая контрастивное обучение и классификацию, а также обсуждаются различные лоссы,
  метрики оценки и практические применения, такие как поиск ближайших соседей, кластеризация
  и улучшение машинного обучения.
layout: post
...
![](/assets/images/553f2d29.png)

*Когда писал про миллион, думал что образно*
