---
date: 2026-09-24 17:32:01 +0000
excerpt: В посте описывается система безопасности для ИИ-агентов, которые используются в компании для автоматизации различных задач — от ответов сотрудникам в чатах до управления инфраструктурой. Основной принцип защиты — опасные действия либо полностью недоступны агентам, либо требуют явного подтверждения человека, при этом безопасность обеспечивается детерминированной обвязкой (белыми списками действий, фиксированными командами вместо произвольного выполнения, разделением прав между процессами), а не только инструкциями в промпте. Дополнительно реализована защита от утечек данных через фильтрацию секретов и персональной информации перед отправкой в модель, а также логирование всех действий для аудита.
layout: post
source_type: direct
tags:
- жека
