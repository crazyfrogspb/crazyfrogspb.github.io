...
excerpt: 'Пост описывает систему общей базы знаний на основе LLM, которая объединяет информацию из разных источников (Google Docs, Mattermost, Telegram, Basecamp) в двухслойное хранилище: сырые документы и переработанную вики, которую ведут ИИ-агенты через специальные скиллы. Система позволяет CTO и Head of AI работать с актуальным контекстом без необходимости вручную собирать информацию, подтягивая релевантные данные из совместных обсуждений и личных заметок через поиск и синтез в Claude.'
layout: post
source_type: direct
tags:
- жека
