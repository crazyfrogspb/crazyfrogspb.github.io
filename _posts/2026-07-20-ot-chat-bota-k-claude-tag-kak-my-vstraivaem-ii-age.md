...
excerpt: 'В посте описывается внедрение ИИ-агентов в компании Цельса через пять уровней
  интеграции: от ограниченного доступа к полной автономии. Рассказывается о практической
  реализации общего ИИ-агента в Mattermost, который получает доступ к базе знаний,
  логам и коду через MCP-реестр, позволяя сотрудникам быстро расследовать инциденты
  и получать статистику, а также об ИИ-дежурном, который проактивно анализирует новые
  инциденты. Подчёркивается важность безопасности, наблюдаемости и накопления контекста
  для превращения ИИ в полноценного члена команды.'
layout: post
source_type: direct
tags:
- жека
