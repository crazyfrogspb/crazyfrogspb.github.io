...
excerpt: 'В посте описывается опыт разработки Android SSH-приложения Multitab SSH с использованием AI-фреймворков CodeSpeak и BMAD без написания кода вручную. Несмотря на возможности современных LLM, процесс оказался сложным и затянулся на пару месяцев, потребовав постоянного вмешательства пользователя, управления требованиями и ручного тестирования, что привело к созданию полнофункционального приложения на 33 тысячи строк кода. Вывод: рынок традиционного ПО не мёртв, так как разработка с помощью AI остаётся дорогостоящей, требует технических знаний и не решает проблему поддержки готового продукта.'
layout: post
source_type: direct
tags:
- жека
...
В последнее время в Твиттере часто проскакивает мысль, что рынок ПО радикально изменится. Модели стали настолько мощными, что можно написать любое приложение именно под свои потребности, а не покупать готовое. Я решил проверить эту гипотезу и написать своё Android-приложение, не написав ни строчки кода.
